...
class AppServiceProvider extends ServiceProvider {
    ...
    public function boot()
    {
        ...
        view()->composer('core.partials.layouts.master', function($view) {
            $site_title = Setting::where('name', '=', 'site.name')->first();
            $site_theme = Setting::where('name', '=', 'theme.bootstrap')->first();
            $navbar_style = Setting::where('name', '=', 'theme.nav.style')->first();
            $recaptcha_enabled = Setting::where('name', '=', 'auth.captcha')->first();
