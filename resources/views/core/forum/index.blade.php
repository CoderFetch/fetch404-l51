			...
			@foreach($categories->all() as $category)
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><a href="{{{ $category->Route }}}"@if ($category->description != null)data-type="tooltip" data-original-title="{{{ $category->description }}}" data-placement="right" @endif>{{{ $category->name }}}</a></h3>
					</div>
