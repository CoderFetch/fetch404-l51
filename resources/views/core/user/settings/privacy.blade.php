    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="show_when_im_online" data-bswitch{{{ Auth::user()->getSetting("privacy.show_online", 0) == '1' ? ' checked' : '' }}} />
            </div>
            <div class="form-group">
                {!! Form::label('allow_bots_to_index_me', 'Allow my profile to be indexed?') !!}
                <input type="checkbox" name="allow_bots_to_index_me" data-bswitch{{{ Auth::user()->getSetting("privacy.bots", 0) == '1' ? ' checked' : '' }}} />
            </div>
            <div class="form-group">
